...
public partial class _Default : System.Web.UI.Page 
{
    ...
    protected void moveup(object sender, EventArgs e)
    {
        ...
        if (btn.ID == "upList1")
        {
            if (ListBox1.SelectedIndex > 0)
            {
                ...
                Response.Write("<div align=center><h2>Cannot move up further</h2></div>");
        }
    ...
    protected void movedown(object sender, EventArgs e)
    {
        ...
        if (btn.ID == "downList1")
        {
            if (ListBox1.SelectedIndex != ListBox1.Items.Count - 1)
            {
                ...
                Response.Write("<div align=center><h2>Cannot move down further</h2></div>");
        }
    ...
    protected void showSelection(object sender, EventArgs e)
    {
        lit1.Text = "";
        for (int i = 0; i < CheckBoxList1.Items.Count; i++)
        {
            if (CheckBoxList1.Items[i].Selected==true)
                lit1.Text += CheckBoxList1.Items[i].Text + "<br />";
        }
    }
    protected void RadioList1_SelectedIndexChanged(object sender, EventArgs e)
    {
        tb1.BackColor = System.Drawing.Color.FromName(RadioList1.SelectedValue);
    }
}
