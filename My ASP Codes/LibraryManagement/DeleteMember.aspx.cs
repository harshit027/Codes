...
public partial class DeleteMember : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            string qry = "delete from members where memberid=" + TextBox1.Text;
            com.CommandText = qry;
            if (com.ExecuteNonQuery() > 0)
            {
                Label1.Text = "<span style='color:green'>Member Deleted</span>";
            }
            else
            {
                Label1.Text = "<span style='color:green'>Member Cannot be Deleted</span>";
            }
            Label1.Visible = true;
        }
        catch (Exception ex)
