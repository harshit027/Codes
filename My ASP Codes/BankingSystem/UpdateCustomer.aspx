<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="UpdateCustomer.aspx.cs" Inherits="UpdateCustomer" Title="Untitled Page" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
<br /><br />
<table width="500px" cellspacing="0" cellpadding="6" border="1" align="center" >
<tr>
<th colspan="2" style="background-color:White; color:#6688ff;"><u><b>UPDATE CUSTOMER</b></u></th>
</tr>
...
<tr>
<th colspan="2">
<asp:Button ID="showDataBTN" runat="server" Text="Show"  onclick="showDataBTN_Click" />
